...
import com.app.spos.model.Suppliers;
import com.app.spos.model.WeightUnit;
...
public class AddProductActivity extends BaseActivity {
    ...
    EditText etxtProductName,etxtProductStock,etxtTax, etxtProductCategory, etxtProductDescription, etxtProductSellPrice, etxtProductSupplier, etxtProdcutWeightUnit,etxt_product_type, etxtProductWeight;
    TextView txtAddProdcut, txtChooseImage,tv_product_stock,tv_select_supplier;
    ImageView imgProduct, imgScanCode;
    List<Category> productCategory;
    List<Suppliers> productSuppliers;
    List<WeightUnit> weightUnits;

    ArrayAdapter<String> categoryAdapter, supplierAdapter, weightUnitAdapter,productTypeAdapter;
    List<String> categoryNames, supplierNames, weightUnitNames,productTypes;

    String selectedCategoryID="", selectedSupplierID="1", selectedWeightUnitID="",mediaPath="";
     String selectedItem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etxt_product_type   = findViewById(R.id.etxt_product_type);
        ...
        tv_select_supplier = findViewById(R.id.tv_select_supplier);
        ...
        etxt_product_type.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                productTypeAdapter = new ArrayAdapter<>(AddProductActivity.this, android.R.layout.simple_list_item_1);
                ...
                dialogTitle.setText(R.string.product_type);
                dialogList.setVerticalScrollBarEnabled(true);
                dialogList.setAdapter(productTypeAdapter);
                ...
                dialogInput.addTextChangedListener(new TextWatcher() {
                    ...
                    @Override
                    public void onTextChanged(CharSequence charSequence, int start, int before, int count) {
                        productTypeAdapter.getFilter().filter(charSequence);
                    }
                ...
                dialogList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        alertDialog.dismiss();
                         selectedItem = productTypeAdapter.getItem(position);
                        if(selectedItem.equalsIgnoreCase("Service")){
                            tv_product_stock.setVisibility(View.GONE);
                            etxtProductStock.setVisibility(View.GONE);
                        }else{
                            tv_product_stock.setVisibility(View.VISIBLE);
                            etxtProductStock.setVisibility(View.VISIBLE);
                        }

                        etxt_product_type.setText(selectedItem);
        ...
        txtAddProdcut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (productName.isEmpty()) {
                    ...
                    addProduct(productName, productCode, productCategoryId, productDescription, productSellPrice,  productWeight,productWeightUnitId,productSupplierId,productStock,tax,shopID,ownerId,selectedItem);
    ...
    private void  addProduct(String productName,String productCode,String productCategoryId,String productDescription, String productSellPrice, String productWeight,String productWeightUnitId,String productSupplierId,String productStock,String tax,String shopId,String ownerId,String selectedItem) {
        ...
        if (mediaPath.isEmpty()) {
            ...
            RequestBody productType = RequestBody.create(MediaType.parse("text/plain"), selectedItem);
            ...
            RequestBody product_type = RequestBody.create(MediaType.parse("text/plain"), selectedItem);



            ApiInterface getResponse = ApiClient.getApiClient().create(ApiInterface.class);
            Call<Product> call = getResponse.addProduct(fileToUpload, filename, name,productType, code, category, description, sellPrice, weight, weightUnitId, supplierId, stock, getTax, getShopId, getOwnerId,product_type);
