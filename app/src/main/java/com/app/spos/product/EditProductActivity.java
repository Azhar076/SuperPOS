...
public class EditProductActivity extends BaseActivity {
    ...
    EditText etxtProductName, etxtProductStock, etxtTax, etxtProductCategory, etxtProductDescription, etxtProductSellPrice, etxtProductSupplier, etxtProdcutWeightUnit, etxtProductWeight,etxt_product_type;
    ...
    LinearLayout li_productType,li_productStock,li_productSupplier;

    String selectedCategoryID, selectedSupplierID, selectedWeightUnitID, productID,productType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        li_productType = findViewById(R.id.li_productType);
        li_productStock = findViewById(R.id.li_productStock);
        li_productSupplier = findViewById(R.id.li_productSupplier);
        ...
        etxt_product_type.setEnabled(false);
        ...
        txtUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String productType = etxt_product_type.getText().toString();
                ...
                if (productName.isEmpty()) {
                    ...
                    etxt_product_type.setError(getString(R.string.product_type_cannot_be_empty));
                    etxt_product_type.requestFocus();
                    ...
                    updateProduct(productName, productCode, selectedCategoryID, productDescription, productSellPrice, productWeight, selectedWeightUnitID, selectedSupplierID, productStock, tax,productType);
            ...
            public void onResponse(@NonNull Call<List<Product>> call, @NonNull Response<List<Product>> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (productData.isEmpty()) {
                        ...
                        String product_type = productData.get(0).getProductType();

                        if(product_type.equals("Service")){
                            li_productStock.setVisibility(View.GONE);
                            li_productSupplier.setVisibility(View.GONE);
                        }else{
                            li_productStock.setVisibility(View.VISIBLE);
                            li_productSupplier.setVisibility(View.VISIBLE);
                        }
                        ...
                        etxt_product_type.setText(product_type);
    ...
    private void updateProduct(String productName, String productCode, String productCategoryId, String productDescription, String productSellPrice, String productWeight, String productWeightUnitId, String productSupplierId, String productStock, String tax,String productType) {
        ...
        RequestBody product_type = RequestBody.create(MediaType.parse("text/plain"), productType);
        ...
        if (mediaPath.equals("na")) {
            ...
            call = getResponse.updateProduct(fileToUpload, filename, name, code, category, description, sellPrice, weight, weightUnitId, supplierId, stock, getProductID, getTax,product_type);
        }
