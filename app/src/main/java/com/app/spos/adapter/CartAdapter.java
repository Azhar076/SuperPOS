...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.MyViewHolder> {
    ...
    DecimalFormat f;
    double priceWithTax;
   public static  double  totalpriceWithoutTax;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
     ...
     if(taxType.equals("exclusive")){
         ...
         allTax = priceWithTax/1.15;
         allTax = priceWithTax - allTax;

          totalpriceWithoutTax  = totalPrice-allTax;


     }

        txtTotalPrice.setText(context.getString(R.string.price_without_tax) + currency + f.format(totalpriceWithoutTax)+"\nTotal Tax: "+currency+f.format(allTax)+"\nPrice with Tax: "+currency+f.format(priceWithTax));
        ...
        if(productName.equals("service1")){
