...
import com.app.spos.pos.CartCount;
...
public class PosProductAdapter extends RecyclerView.Adapter<PosProductAdapter.MyViewHolder> {
    ...
    public PosProductAdapter(Context context, List<Product> productData, CartCount cartCount) {
        this.context = context;
        this.productData = productData;
        this.cartCount1 = cartCount;
    ...
    public void onBindViewHolder(@NonNull final PosProductAdapter.MyViewHolder holder, int position) {
        ...
        String productType = productData.get(position).getProductType();
      ...
      double  taxAmount;
        if(taxType.equals("exclusive")){
             taxAmount=(itemPrice*getTax)/100;
        }else{
            double divider =getTax/100+1;
            double withoutTaxRate = itemPrice/divider;
            taxAmount = itemPrice - withoutTaxRate;
        }
        ...
        if (getStock>5) {
            ...
            if(productType!= null && productType.equalsIgnoreCase("Service")){
