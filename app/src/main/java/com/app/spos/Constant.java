...
public class Constant {
   ...
   // public static final String BASE_URL = "https://demo.onlinesoftsell.com/superpos/api/";
    public static final String BASE_URL = "https://superpos.ishtrii.com/api/";

    //For retrofit base url must end with /
   // public static final String PRODUCT_IMAGE_URL = "https://demo.onlinesoftsell.com/superpos/product_images/";
    public static final String PRODUCT_IMAGE_URL = "https://superpos.ishtrii.com/product_images/";
    ...
    public static final String CUSTOMER_VATNO="vat_no";
    ...
    public static final String SP_VAT_NO="shop_vat_no";
