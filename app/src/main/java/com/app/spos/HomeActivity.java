...
import com.app.spos.pos.PosActivity;
import com.app.spos.product.ProductActivity;
import com.app.spos.report.ReportActivity;
import com.app.spos.settings.SettingsActivity;
import com.app.spos.suppliers.SuppliersActivity;
import com.app.spos.utils.BaseActivity;
import com.app.spos.utils.LocaleManager;
...
public class HomeActivity extends BaseActivity {
    ...
    CardView cardCustomers, cardProducts, cardSupplier, cardPos,card_customers_receive, cardOrderList, cardReport, cardSettings, cardExpense, cardLogout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card_customers_receive = findViewById(R.id.card_customers_receive);
...
//       Admob initialization
        ...
        card_customers_receive.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
            //    Intent intent = new Intent(HomeActivity.this, AddCustomerReceiveActivity.class);
                Intent intent = new Intent(HomeActivity.this, AllCustomers.class);
                startActivity(intent);
        ...
        cardLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogBuilder
                        ...
                        .withEffect(Slidetop)
                        .withDialogColor("#6E746E") //use color code for dialog
