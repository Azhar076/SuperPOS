        ...
        call.enqueue(new Callback<Login>() {
            ...
            public void onResponse(@NonNull Call<Login> call, @NonNull Response<Login> response) {
                ...
                if (response.body() != null && response.isSuccessful()) {
                    ...
                    String shop_vat_no = response.body().getShop_vat_no();
                    String logo = response.body().getLogo();
                    String tax_type = response.body().getTax_type();
                    String id = response.body().getId();

                    if (shopName != null || shopAddress != null || shopContact != null || shopEmail != null || tax != null || currencySymbol != null || shopStatus != null || staffId != null || staffName != null || userType != null || id !=null) {
                        ...
                        if (shopStatus.equals(Constant.STATUS_CLOSED)) {
                            ...
                            editor.putString(Constant.SP_VAT_NO, shop_vat_no);
                            editor.putString(Constant.SP_LOGO, logo);
                            editor.putString(Constant.TAX_TYPE, tax_type);
                            editor.putString(Constant.SP_USER_ID, id);
