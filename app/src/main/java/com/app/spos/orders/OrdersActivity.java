...
public class OrdersActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String user_type = sp.getString(Constant.USER_TYPE, "");
        String staff_id = sp.getString(Constant.SP_USER_ID, "");
        ...
        mSwipeRefreshLayout.setOnRefreshListener(() -> {
            ...
            {
                getOrdersData("",shopID,ownerId,user_type,staff_id);
            }
            else
            {
        ...
        etxtSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (s.length() > 1) {
                    ...
                    getOrdersData(s.toString(),shopID,ownerId,user_type,staff_id);
                } else {
                    getOrdersData("",shopID,ownerId,user_type,staff_id);
                }
    ...
    public void getOrdersData(String searchText,String shopId,String ownerId,String user_type,String staff_id) {

        ApiInterface apiInterface = ApiClient.getApiClient().create(ApiInterface.class);
        Call<List<OrderList>> call = apiInterface.getOrders(searchText,shopId,ownerId,user_type,staff_id);
