package com.app.spos.settings.shop;
...
public class ShopInformationActivity extends BaseActivity {
    ...
    EditText etxtShopName, etxtShopContact, etxtShopEmail, etxtShopAddress,extShopVatno,extTaxtype;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        extShopVatno = findViewById(R.id.etxt_vat_no);
        extTaxtype = findViewById(R.id.etxt_tax_type);
        ...
        extShopVatno.setEnabled(false);
        extTaxtype.setEnabled(false);
            ...
            public void onResponse(@NonNull Call<List<ShopInformation>> call, @NonNull Response<List<ShopInformation>> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (shopInformation.isEmpty()) {
                        ...
                        String shopVatNo=shopInformation.get(0).getShop_vat_no();
                        String taxType=shopInformation.get(0).getTax_type();
                        String img_url=shopInformation.get(0).getLogo();
                        ...
                        extShopVatno.setText(shopVatNo);
                        extTaxtype.setText(taxType);
                        String imageUrl = "https://superpos.ishtrii.com/shops_images/"+img_url;
