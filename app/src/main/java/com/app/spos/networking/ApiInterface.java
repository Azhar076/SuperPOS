package com.app.spos.networking;
...
import com.app.spos.model.Expense;
import com.app.spos.model.ExpenseReport;
import com.app.spos.model.Login;
import com.app.spos.model.MonthData;
import com.app.spos.model.OrderDetails;
import com.app.spos.model.OrderList;
import com.app.spos.model.Product;
import com.app.spos.model.SalesReport;
import com.app.spos.model.ShopInformation;
...
public interface ApiInterface {
    ...
    //get customers data default

    @GET("get_default_customer.php")
    Call<List<Customer>> getCustomerDefault(
            @Query(Constant.SP_SHOP_ID) String shopId
    ...
    Call<Customer> addCustomers(
            ...
            @Field(Constant.CUSTOMER_VATNO) String vat_no,
    ...
    @FormUrlEncoded
    @POST("customer_receive.php")
    Call<JSONObject> addCustomersReceive(
            @Field(Constant.CUSTOMER_ID) String customerId,
            @Field(Constant.PAY_DATE) String pay_date,
            @Field(Constant.NOTE) String note,
            @Field(Constant.AMOUNT) String amount,
            @Field(Constant.PAY_TYPE) String pay_type,
            @Field(Constant.SP_SHOP_ID) String shopId,
            @Field(Constant.SP_OWNER_ID) String ownerId,
            @Field(Constant.STAFF_ID) String staff_id);

    @GET("get_customers_receive.php")
    Call<List<getAllCustomersReceiveModel>> getAllCustomers(
            @Query(Constant.SHOP_ID) String shopId,
            @Query(Constant.STAFF_ID) String staff_id
    );
    ...
    Call<Customer> updateCustomers(
            ...
            @Field(Constant.CUSTOMER_CELL) String cell,
            @Field(Constant.CUSTOMER_EMAIL) String email,
            @Field(Constant.CUSTOMER_VATNO) String vatno,
            @Field(Constant.CUSTOMER_ADDRESS) String address);
    ...
    Call<Product> addProduct(@Part MultipartBody.Part file,
                             ...
                             @Part(Constant.PRODUCT_TYPE) RequestBody productType,
                             ...
                             @Part(Constant.PRODUCT_TYPE) RequestBody product_type);
