                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (salesReport.isEmpty()) {
                        ...
                        Log.d("Data", "Empty");
                         ...
                         totalOrderPrice=salesReport.get(0).getTotalOrderPrice();
                        ...
                        if (totalOrderPrice!=null) {
                          ...
                          //  txtTotalPrice.setText(getString(R.string.total_price) + "=" + currency + f.format(Double.parseDouble(totalOrderPrice)));
                            ...
                            txtNetSales.setText(getString(R.string.net_sales) + "=" + currency + totalOrderPrice);
                        }
                        else
                        {
            ...
            public void onResponse(@NonNull Call<List<OrderDetails>> call, @NonNull Response<List<OrderDetails>> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (orderDetails.isEmpty()) {
                        ...
                        String price,qty;
                        double costTotal,final_total_all_items=0;
                        for (int i = 0; i < orderDetails.size(); i++) {
                            ...
                            txtTotalPrice.setText(getString(R.string.total_price) + "=" + currency + f.format(final_total_all_items));
