...
public class EditCustomersActivity extends BaseActivity {
    ...
    EditText etxtCustomerName, etxtAddress, etxtCustomerCell, etxtCustomerEmail,etxt_vatNo;
    TextView txtEditCustomer, txtUpdateInformation;
    String getCustomerId, getCustomerName, getCustomerCell, getCustomerEmail, getCustomerAddress,getCustomerVatNo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etxt_vatNo = findViewById(R.id.etxt_vatNo);
        ...
        getCustomerVatNo = getIntent().getExtras().getString("customer_vatno");
        ...
        etxt_vatNo.setText(getCustomerVatNo);
        ...
        txtUpdateInformation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String customerVatNo = etxt_vatNo.getText().toString().trim();
                ...
                if (customerName.isEmpty()) {
                    ...
                    etxt_vatNo.setError(getString(R.string.customer_vatNo));
                    etxt_vatNo.requestFocus();
                }
                else {


                    updateCustomer(getCustomerId, customerName, customerCell, customerEmail,customerVatNo, customerAddress);
    ...
    private void updateCustomer(String id,String name,String cell,String email,String vatNo, String address) {
        ...
        Call<Customer> call = apiInterface.updateCustomers(id,name,cell,email,vatNo,address);
